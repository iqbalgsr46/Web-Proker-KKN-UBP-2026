    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 lg:p-8 touch-none overflow-hidden">
        ...
        >
          ...
          <div className="flex-none text-center mb-6 sm:mb-8 mt-4 sm:mt-0 relative z-10">
            <span className="inline-block py-1 px-5 rounded-full bg-red-50 text-red-600 font-extrabold text-xs sm:text-sm tracking-widest uppercase mb-3 border-2 border-red-500/30 shadow-sm">
              Galeri Edukasi
            </span>
          ...
          <div className="flex-1 min-h-0 w-full mx-auto flex items-center justify-center relative z-10">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6 w-full h-full sm:h-auto content-center">
              {b3Items.map((item, index) => (
                <div key={index} className="group flex flex-col items-center justify-center p-3 sm:p-4 rounded-3xl bg-white/60 backdrop-blur-md border-2 border-white/50 hover:border-google-red hover:shadow-[4px_4px_0px_#ea4335] transition-all hover:-translate-y-1 h-full max-h-[140px] sm:max-h-[180px] lg:max-h-[200px]">
