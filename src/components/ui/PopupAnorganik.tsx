    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 lg:p-8 overflow-hidden">
        ...
        >
          ...
          <div className="flex-none text-center mb-4 sm:mb-8 mt-6 sm:mt-0 relative z-10 px-6 sm:px-0">
            <span className="inline-block py-0.5 sm:py-1 px-4 sm:px-5 rounded-full bg-yellow-50 text-yellow-600 font-extrabold text-[10px] sm:text-sm tracking-widest uppercase mb-2 sm:mb-3 border-2 border-yellow-400/50 shadow-sm">
              Galeri Edukasi
            </span>
