    ...
    <footer className="relative w-full overflow-hidden bg-black py-20 px-6 sm:px-12 md:px-24">
      <div className="max-w-[90rem] mx-auto relative z-10">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-0 flex justify-center pointer-events-none select-none overflow-hidden">
          <span className="text-[120px] sm:text-[180px] md:text-[250px] lg:text-[320px] font-black text-white/5 leading-none tracking-tighter" style={{ transform: "translateY(25%)" }}>
            educoloring
          </span>
        </div>
