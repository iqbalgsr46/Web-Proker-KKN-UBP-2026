  ...
  return (
    <div className="relative w-full min-h-[100dvh] flex flex-col bg-transparent">
      ...
      <main className="flex-1 w-full flex flex-col items-center justify-start p-4 sm:p-6 mt-8 sm:mt-16 z-10">
            ...
            <div className="p-5 sm:p-8 space-y-5">
              ...
              <div>
                ...
                <div className="relative border-2 border-dashed border-gray-200 rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:border-google-blue hover:bg-blue-50/30 transition-all cursor-pointer bg-white/50 min-h-[10rem]">
                  ...
                  />
                  {imagePreview ? (
                    <div className="w-full max-w-[200px] aspect-[3/4] mb-3 relative rounded-xl overflow-hidden border border-gray-200 shadow-sm">
        ...
        {/* Info text */}
        <p className="text-xs text-gray-400 font-medium mt-6 text-center max-w-sm text-balance">
