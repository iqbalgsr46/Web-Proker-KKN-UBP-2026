    ...
    <main className="w-full max-w-[100vw] min-h-screen bg-transparent relative flex flex-col items-center overflow-x-hidden">
      ...
      <section className="w-full overflow-x-hidden flex flex-col items-center justify-start relative pt-12 sm:pt-16 md:pt-24 pb-8 md:pb-12 z-10">
        <div className="flex flex-col items-center justify-start w-full max-w-7xl mx-auto gap-6 md:gap-12 px-4 sm:px-8">
          ...
          <div className="text-center relative z-10 w-full flex flex-col items-center">
            ...
            <div className="flex flex-row items-center justify-center gap-0 sm:gap-2 mb-6 scale-90 sm:scale-100">
              ...
              <div className="flex flex-col items-center justify-center px-4 md:px-6 w-fit">
                <h1 className="pt-2 text-3xl md:text-4xl lg:text-[2.75rem] font-black text-gray-900 tracking-tight text-center mb-1 leading-none break-words">
                  Kategori
                  <br />
            ...
            <p className="text-gray-600 font-medium text-base md:text-lg max-w-xl mx-auto mb-6 sm:mb-8 text-balance px-4 -mt-2">
            ...
            {/* 3 iPhones Showcase */}
            <div className="flex flex-row items-center justify-center gap-2 sm:gap-4 md:gap-8 mt-12 sm:mt-16 md:mt-24 w-full max-w-[1000px] mx-auto z-20 relative">
              <div className="w-[30%] max-w-[300px] transform-gpu hover:scale-105 transition-transform duration-500 origin-bottom">
                <Iphone className="w-full shadow-2xl shadow-gray-900/20" videoSrc="/videos/Buat_video_gambar_bergerak_202608022245.mp4" />
              </div>
              <div className="w-[30%] max-w-[300px] transform-gpu hover:scale-105 -translate-y-4 md:-translate-y-8 transition-transform duration-500 origin-bottom z-10">
            ...
            <div className="mt-8 md:mt-16 flex justify-center z-30 relative duration-700 delay-300">
              <PillButton href="/kumpulan-mewarnai" variant="blue" className="group">
      ...
      <section className="w-full overflow-x-hidden flex flex-col items-center justify-center relative pt-8 md:pt-16 pb-16 md:pb-24 z-10">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 flex flex-col items-center">
          ...
          {/* Features Header */}
          <div className="text-center mb-16 sm:mb-24 lg:mb-32 flex flex-col items-center">
            <span className="text-google-blue font-extrabold tracking-widest uppercase text-sm mb-2">AYO MULAI MEMILAH!</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 tracking-tighter break-words">
              Mengenal 3 Jenis Sampah
            </h2>
          </div>

          {/* Features Rows */}
          <div className="flex flex-col w-full gap-24 md:gap-32 lg:gap-40">
            
            {/* Feature 1 */}
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 w-full">
              {/* Left: iPhone */}
              <div className="w-full max-w-[320px] lg:max-w-[350px] shrink-0 mx-auto lg:mx-0 lg:translate-x-16 transform-gpu hover:scale-[1.02] transition-transform duration-500">
                 <Iphone className="w-full shadow-2xl shadow-gray-900/20" videoSrc="/videos/Gambar_anak_SD_jadi_bergerak_202608022229.mp4" startTime={1.5} />
              </div>
              {/* Right: Text & Button */}
              <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg mx-auto lg:mx-0 lg:-translate-x-16 w-full px-2 sm:px-0">
                <h3 className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight leading-[1.1] mb-4">
                  Mengenal Sampah Organik
                </h3>
                <p className="text-gray-600 text-base sm:text-lg md:text-xl mb-6 sm:mb-8 leading-relaxed text-balance">
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16 w-full">
              {/* Left: Text & Button */}
              <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg mx-auto lg:mx-0 lg:-translate-x-16 lg:ml-auto w-full px-2 sm:px-0">
                <h3 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 leading-[1.1] mb-4 sm:mb-6 tracking-tighter">
              ...
              {/* Right: iPhone */}
              <div className="w-full max-w-[320px] lg:max-w-[350px] shrink-0 mx-auto lg:mx-0 lg:mr-auto lg:translate-x-16 transform-gpu hover:scale-[1.02] transition-transform duration-500">
                 <Iphone className="w-full shadow-2xl shadow-gray-900/20" videoSrc="/videos/Buat_video_gambar_bergerak_202608022245.mp4" />
              </div>
            </div>
