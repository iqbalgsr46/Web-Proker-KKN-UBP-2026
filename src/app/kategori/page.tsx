  ...
  return (
    <main className="h-[100dvh] bg-transparent relative flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none bg-white">
        ...
        <AbstractBlob type="gemini-spark" color="blue" className="absolute top-[5%] left-[-5%] w-64 md:w-96 h-64 md:h-96 opacity-20 rotate-12 pointer-events-none transform-gpu" />
        <AbstractBlob type="circle-spark" color="yellow" className="absolute top-[25%] right-[2%] w-32 md:w-48 h-32 md:h-48 opacity-20 -rotate-12 pointer-events-none transform-gpu blur-[2px]" />
        ...
        <AbstractBlob type="gemini-spark" color="blue" className="absolute top-[70%] right-[-10%] w-72 md:w-[500px] h-72 md:h-[500px] opacity-15 -rotate-[25deg] pointer-events-none transform-gpu blur-[4px]" />
        ...
        <AbstractBlob type="cross" color="red" className="absolute top-[18%] left-[25%] w-16 md:w-24 h-16 md:h-24 opacity-15 rotate-[30deg] pointer-events-none transform-gpu" />
      ...
      <div className="w-full flex-1 flex items-center justify-center pt-4 pb-24 md:py-0">
        <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-7xl mx-auto gap-12 px-4 sm:px-8">
          ...
          <div className="text-center lg:text-left relative z-10 w-full lg:w-[45%] flex flex-col items-center lg:items-start">
            ...
            <Link href="/kumpulan-mewarnai" className="inline-block">
                    ...
                    <GlassCard className="h-full w-full flex flex-col items-center text-center p-4 sm:p-6 transition-all duration-500 hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.3)] relative !bg-white/95">
                      ...
                      {cat.blobs.map((blob, idx) => (
                        <AbstractBlob 
                          ...
                          className={`absolute ${blob.position} opacity-25 transition-all duration-700 z-0 pointer-events-none transform-gpu`} 
                        />
                      ))}
