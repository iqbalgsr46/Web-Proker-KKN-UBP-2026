  ...
  return (
    <div className="relative w-full min-h-[100dvh] flex flex-col bg-transparent">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none bg-white overflow-hidden">
        ...
        {/* Tambahan Blobs Ekstra (Sembunyikan di HP untuk performa) */}
        ...
        {/* 6+ Tambahan Baru (Sembunyikan di Layar Kecil/Menengah untuk performa) */}
        ...
        {/* Glow Biru (Atas Kiri) */}
        <div 
          className="hidden md:block absolute -top-[20%] -left-[10%] w-[60%] h-[60%] rounded-full bg-google-blue/20 blur-[60px] md:blur-[80px] transform-gpu will-change-transform pointer-events-none" 
        />
        {/* Glow Merah (Atas Kanan) */}
        <div 
          className="hidden md:block absolute top-[5%] -right-[10%] w-[50%] h-[50%] rounded-full bg-google-red/10 blur-[60px] md:blur-[80px] transform-gpu will-change-transform pointer-events-none" 
        />
        {/* Glow Kuning (Bawah Kiri) */}
        <div 
          className="hidden md:block absolute -bottom-[20%] left-[10%] w-[60%] h-[60%] rounded-full bg-google-yellow/20 blur-[60px] md:blur-[80px] transform-gpu will-change-transform pointer-events-none" 
        />
        {/* Glow Hijau (Bawah Kanan) */}
        <div 
          className="hidden md:block absolute bottom-[5%] right-[5%] w-[50%] h-[50%] rounded-full bg-google-green/10 blur-[60px] md:blur-[80px] transform-gpu will-change-transform pointer-events-none" 
        />
      </div>
